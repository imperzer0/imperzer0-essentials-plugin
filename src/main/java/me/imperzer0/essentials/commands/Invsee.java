    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args)
    {
...

        {
            ...
            if (player == sender_p)
            {
                ...
                loger.error(sender, "You can't open your own inventory.\n"
                         + "If you didn't know, your name is " + ChatColor.GOLD + player.getDisplayName());
                return false;
            }
            ...
            if (player != null)
            {
                ...
                } else
                {
                    ...
                    loger.message(sender, ChatColor.GRAY + "Opened "
                            + ChatColor.GOLD + player.getDisplayName()
                            + ChatColor.GRAY + "'s inventory");
                }
...

        {
            ...
            loger.message(sender, ChatColor.GRAY + "Player "
                    + ChatColor.GOLD + args[0]
                    + ChatColor.GRAY + " isn't online\n"
                    + ChatColor.YELLOW + "Opening archive...");
            try
            {
            ...
            {
                loger.error(sender, "This inventory does not exist in archive.");
                return false;
            }
