    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args)
    {
        ...
        if (args.length == 0)
            if (sender instanceof HumanEntity human)
            {
                ...
                loger.message(sender, ChatColor.DARK_AQUA + "Gave owner kit to " +
            ...
            if (sender instanceof HumanEntity human)
            {
                ...
                loger.message(sender, ChatColor.DARK_AQUA + "Applied owner kit enchantments to " +
            ...
            if (sender instanceof HumanEntity human)
            {
                ...
                Inventory inventory = Bukkit.createInventory(human, 18, ChatColor.GOLD + "OwnerKitInventory");
                ...
                loger.message(sender, ChatColor.DARK_AQUA + "Opening inventory for " +
                        ChatColor.GOLD + human.getName() + ChatColor.DARK_AQUA + "...");
