...
public class OfflineGM extends me.imperzer0.essentials.commands.Command implements TabCompleter
{
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args)
    {
        ...
        if (player != null)
        {
            ...
            loger.message(sender, ChatColor.GRAY + "Changed " + ChatColor.GOLD + player.getName() +
                    ChatColor.GRAY + "'s GameMode to " +
                    ChatColor.LIGHT_PURPLE + player.getGameMode().toString().toLowerCase());
            return true;
        }
        ...
        loger.message(sender, ChatColor.GRAY + "Will change " + ChatColor.GOLD + offline_player.getName() +
                ChatColor.GRAY + "'s GameMode to " + ChatColor.LIGHT_PURPLE + gm.name().toLowerCase());
